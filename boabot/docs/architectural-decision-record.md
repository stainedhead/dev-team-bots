...
**Decision:** Three coupled decisions extend native daemon mode's single-identity Buzz wiring to N `team.yaml` personas (spec: `specs/260814-boabot-native-daemon-mode/`):
