...
- Provides commands for Kanban board management, team inspection, user administration, profile management, and Agent Skills lifecycle management.
...
- **Admins** — manage users, inspect team health, manage the board, approve and manage Agent Skills.
